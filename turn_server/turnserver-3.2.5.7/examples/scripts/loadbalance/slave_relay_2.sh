...
PATH="./bin/:../bin/:../../bin/:${PATH}" turnserver --syslog  -L 127.0.0.1 -E 127.0.0.1 --max-bps=3000000 -f -m 3 --min-port=20000 --max-port=29999  --log-file=stdout -v --no-dtls --no-tls -p 4444 --cli-port=5768 $@
