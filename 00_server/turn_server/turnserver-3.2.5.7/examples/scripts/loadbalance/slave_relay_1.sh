...
PATH="./bin/:../bin/:../../bin/:${PATH}" turnserver --syslog  -L 127.0.0.1 -E 127.0.0.1 --max-bps=3000000 -f -m 3 --min-port=10000 --max-port=19999  --log-file=stdout -v --no-dtls --no-tls -p 3333 --cli-port=5767 $@
